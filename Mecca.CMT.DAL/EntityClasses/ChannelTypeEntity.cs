...
namespace Mecca.CMT.DAL.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'ChannelType'. <br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class ChannelTypeEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public ChannelTypeEntity() :base("ChannelTypeEntity")
		{
			InitClassEmpty(null);
		}
		...
		public ChannelTypeEntity(System.Int32 channelTypeId):base("ChannelTypeEntity")
		{
			InitClassFetch(channelTypeId, null, null);
		}
		...
		/// <summary>CTor</summary>
		/// <param name="channelTypeId">PK value for ChannelType which data should be fetched into this ChannelType object</param>
		/// <param name="validator">The custom validator object for this ChannelTypeEntity</param>
		public ChannelTypeEntity(System.Int32 channelTypeId, IValidator validator):base("ChannelTypeEntity")
		{
			InitClassFetch(channelTypeId, validator, null);
		}

		/// <summary>Private CTor for deserialization</summary>
		/// <param name="info"></param>
		/// <param name="context"></param>
		protected ChannelTypeEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "Channels":
					toReturn.Add(Relations.ChannelEntityUsingChannelTypeId);
					break;
				default:
					break;				
			}
		...
		public bool FetchUsingPK(System.Int32 channelTypeId)
		{
			return FetchUsingPK(channelTypeId, null, null, null);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int32 channelTypeId, IPrefetchPath prefetchPathToUse)
		{
			return FetchUsingPK(channelTypeId, prefetchPathToUse, null, null);
		}
		...
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int32 channelTypeId, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			return Fetch(channelTypeId, prefetchPathToUse, contextToUse, excludedIncludedFields);
		}
		...
		{
			return Fetch(this.ChannelTypeId, null, null, null);
		}
		...
		{
			return new ChannelTypeRelations().GetAllRelations();
		}
		...
		public virtual Mecca.CMT.DAL.CollectionClasses.ChannelCollection GetMultiChannels(bool forceFetch, IEntityFactory entityFactoryToUse, IPredicateExpression filter)
		{
			if( ( (!_alreadyFetchedChannels && EntityBase.EnableLazyLoading) || forceFetch || _alwaysFetchChannels) && !this.IsSerializing && !this.IsDeserializing && !this.InDesignMode)
			{
				...
				_channels.GetMultiManyToOne(null, this, null, filter);
		...
		private void InitClassMembers()
		{
			...
			_channels.SetContainingEntityInfo(this, "ChannelType");
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("ChannelTypeName", fieldHashtable);
		}
		#endregion
		...
		/// is set to false, the fields contained in excludedIncludedFields are kept in the query, the rest of the fields in the query are excluded.</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		private bool Fetch(System.Int32 channelTypeId, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			try
			{
				OnFetch();
				this.Fields[(int)ChannelTypeFieldIndex.ChannelTypeId].ForcedCurrentValueWrite(channelTypeId);
		...
		{
			return DAOFactory.CreateChannelTypeDAO();
		}
		...
		{
			return new ChannelTypeEntityFactory();
		}

		#region Class Property Declarations
		/// <summary> The relations object holding all relations of this entity with other entity classes.</summary>
		public  static ChannelTypeRelations Relations
		{
			get	{ return new ChannelTypeRelations(); }
		}
		...
		{
			get { return new PrefetchPathElement(new Mecca.CMT.DAL.CollectionClasses.ChannelCollection(), (IEntityRelation)GetRelationsForField("Channels")[0], (int)Mecca.CMT.DAL.EntityType.ChannelTypeEntity, (int)Mecca.CMT.DAL.EntityType.ChannelEntity, 0, null, null, null, "Channels", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany); }
		}
		...
		/// <summary> The ChannelTypeId property of the Entity ChannelType<br/><br/></summary>
		/// <remarks>Mapped on  table field: "channel_types"."channel_type_id"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int32 ChannelTypeId
		{
			get { return (System.Int32)GetValue((int)ChannelTypeFieldIndex.ChannelTypeId, true); }
			set	{ SetValue((int)ChannelTypeFieldIndex.ChannelTypeId, value, true); }
		}

		/// <summary> The ChannelTypeName property of the Entity ChannelType<br/><br/></summary>
		/// <remarks>Mapped on  table field: "channel_types"."channel_type_name"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 50<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String ChannelTypeName
		{
			get { return (System.String)GetValue((int)ChannelTypeFieldIndex.ChannelTypeName, true); }
			set	{ SetValue((int)ChannelTypeFieldIndex.ChannelTypeName, value, true); }
		}
		...
		{ 
			get { return (int)Mecca.CMT.DAL.EntityType.ChannelTypeEntity; }
		}
