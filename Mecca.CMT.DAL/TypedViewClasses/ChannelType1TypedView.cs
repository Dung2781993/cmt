...
namespace Mecca.CMT.DAL.TypedViewClasses
{
	...
	/// <summary>Typed datatable for the view 'ChannelType1'.</summary>
	[Serializable, System.ComponentModel.DesignerCategory("Code")]
	[ToolboxItem(true)]
	[DesignTimeVisible(true)]
	public partial class ChannelType1TypedView : TypedViewBase<ChannelType1Row>, ITypedView
	// __LLBLGENPRO_USER_CODE_REGION_START AdditionalInterfacesView 
	// __LLBLGENPRO_USER_CODE_REGION_END 
	{
		#region Class Member Declarations
		private DataColumn _columnChannelTypeId;
		private DataColumn _columnChannelTypeName;
	...
	// __LLBLGENPRO_USER_CODE_REGION_END 
		...
		static ChannelType1TypedView()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary>CTor</summary>
		public ChannelType1TypedView():base("ChannelType1")
		{
			InitClass();
		}
		...
		protected ChannelType1TypedView(SerializationInfo info, StreamingContext context):base(info, context)
		{
			InitMembers();
		}
	...
	// __LLBLGENPRO_USER_CODE_REGION_END 
		...
		{
			IEntityFields fieldsInResultset = EntityFieldsFactory.CreateTypedViewEntityFieldsObject(TypedViewType.ChannelType1TypedView);
		...
		{
			return EntityFieldsFactory.CreateTypedViewEntityFieldsObject(TypedViewType.ChannelType1TypedView);
		}
		...
		{
			return new ChannelType1Row(rowBuilder);
		}
	...
	// __LLBLGENPRO_USER_CODE_REGION_END 
		...
		private void InitMembers()
		{
			...
			_columnChannelTypeName = this.Columns["ChannelTypeName"];
	...
	// __LLBLGENPRO_USER_CODE_REGION_END 
		...
		{
			ChannelType1TypedView cloneToReturn = ((ChannelType1TypedView)(base.Clone()));
		...
		{
			return new ChannelType1TypedView();
		}
		...
		{
			get { return ChannelType1TypedView.CustomProperties;}
		}
		...
		{
			get { return ChannelType1TypedView.FieldsCustomProperties;}
		}
		...
		/// <summary>Returns the column object belonging to the TypedView field 'ChannelTypeName'</summary>
		internal DataColumn ChannelTypeNameColumn 
		{
			get { return _columnChannelTypeName; }
		}
	...
	/// <summary>Typed datarow for the typed datatable ChannelType1</summary>
	public partial class ChannelType1Row : DataRow
	// __LLBLGENPRO_USER_CODE_REGION_START AdditionalInterfacesRow 
	// __LLBLGENPRO_USER_CODE_REGION_END 
	{
		#region Class Member Declarations
		private ChannelType1TypedView	_parent;
		#endregion

		/// <summary>CTor</summary>
		/// <param name="rowBuilder">Row builder object to use when building this row</param>
		protected internal ChannelType1Row(DataRowBuilder rowBuilder) : base(rowBuilder) 
		{
			_parent = ((ChannelType1TypedView)(this.Table));
		}

		#region Class Property Declarations
		/// <summary>Gets / sets the value of the TypedView field ChannelTypeId</summary>
		/// <remarks>Mapped on view field: "channel_types"."channel_type_id"<br/>
		...
		/// <summary>Gets / sets the value of the TypedView field ChannelTypeName</summary>
		/// <remarks>Mapped on view field: "channel_types"."channel_type_name"<br/>
		/// View field characteristics (type, precision, scale, length): NVarChar, 0, 0, 50</remarks>
		public System.String ChannelTypeName
		{
			get { return IsChannelTypeNameNull() ? (System.String)TypeDefaultValue.GetDefaultValue(typeof(System.String)) : (System.String)this[_parent.ChannelTypeNameColumn]; }
			set { this[_parent.ChannelTypeNameColumn] = value; }
		}

		/// <summary>Returns true if the TypedView field ChannelTypeName is NULL, false otherwise.</summary>
		public bool IsChannelTypeNameNull() 
		{
			return IsNull(_parent.ChannelTypeNameColumn);
		}

		/// <summary>Sets the TypedView field ChannelTypeName to NULL. Not recommended; a typed list should be used as a readonly object.</summary>
		public void SetChannelTypeNameNull() 
		{
			this[_parent.ChannelTypeNameColumn] = System.Convert.DBNull;
		}
