...
namespace Mecca.CMT.DAL.TypedViewClasses
{
	...
	/// <summary>Typed datatable for the view 'CampaignType1'.</summary>
	[Serializable, System.ComponentModel.DesignerCategory("Code")]
	[ToolboxItem(true)]
	[DesignTimeVisible(true)]
	public partial class CampaignType1TypedView : TypedViewBase<CampaignType1Row>, ITypedView
	// __LLBLGENPRO_USER_CODE_REGION_START AdditionalInterfacesView 
	// __LLBLGENPRO_USER_CODE_REGION_END 
	{
		#region Class Member Declarations
		private DataColumn _columnCampaignTypeId;
		private DataColumn _columnCampaignTypeName;
	...
	// __LLBLGENPRO_USER_CODE_REGION_END 
		...
		static CampaignType1TypedView()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary>CTor</summary>
		public CampaignType1TypedView():base("CampaignType1")
		{
			InitClass();
		}
		...
		protected CampaignType1TypedView(SerializationInfo info, StreamingContext context):base(info, context)
		{
			InitMembers();
		}
	...
	// __LLBLGENPRO_USER_CODE_REGION_END 
		...
		{
			IEntityFields fieldsInResultset = EntityFieldsFactory.CreateTypedViewEntityFieldsObject(TypedViewType.CampaignType1TypedView);
		...
		{
			return EntityFieldsFactory.CreateTypedViewEntityFieldsObject(TypedViewType.CampaignType1TypedView);
		}
		...
		{
			return new CampaignType1Row(rowBuilder);
		}
		...
		protected override void InitClass()
		{
			...
			_columnCampaignTypeName = GeneralUtils.CreateTypedDataTableColumn("CampaignTypeName", @"CampaignTypeName", typeof(System.String), this.Columns);
	...
	// __LLBLGENPRO_USER_CODE_REGION_END 
		...
		private void InitMembers()
		{
			...
			_columnCampaignTypeName = this.Columns["CampaignTypeName"];
	...
	// __LLBLGENPRO_USER_CODE_REGION_END 
		...
		{
			CampaignType1TypedView cloneToReturn = ((CampaignType1TypedView)(base.Clone()));
		...
		{
			return new CampaignType1TypedView();
		}
		...
		{
			get { return CampaignType1TypedView.CustomProperties;}
		}
		...
		{
			get { return CampaignType1TypedView.FieldsCustomProperties;}
		}
		...
		/// <summary>Returns the column object belonging to the TypedView field 'CampaignTypeName'</summary>
		internal DataColumn CampaignTypeNameColumn 
		{
			get { return _columnCampaignTypeName; }
		}
	...
	/// <summary>Typed datarow for the typed datatable CampaignType1</summary>
	public partial class CampaignType1Row : DataRow
	// __LLBLGENPRO_USER_CODE_REGION_START AdditionalInterfacesRow 
	// __LLBLGENPRO_USER_CODE_REGION_END 
	{
		#region Class Member Declarations
		private CampaignType1TypedView	_parent;
		#endregion

		/// <summary>CTor</summary>
		/// <param name="rowBuilder">Row builder object to use when building this row</param>
		protected internal CampaignType1Row(DataRowBuilder rowBuilder) : base(rowBuilder) 
		{
			_parent = ((CampaignType1TypedView)(this.Table));
		}

		#region Class Property Declarations
		/// <summary>Gets / sets the value of the TypedView field CampaignTypeId</summary>
		/// <remarks>Mapped on view field: "campaign_types"."campaign_type_id"<br/>
		...
		/// <summary>Gets / sets the value of the TypedView field CampaignTypeName</summary>
		/// <remarks>Mapped on view field: "campaign_types"."campaign_type_name"<br/>
		/// View field characteristics (type, precision, scale, length): NVarChar, 0, 0, 50</remarks>
		public System.String CampaignTypeName
		{
			get { return IsCampaignTypeNameNull() ? (System.String)TypeDefaultValue.GetDefaultValue(typeof(System.String)) : (System.String)this[_parent.CampaignTypeNameColumn]; }
			set { this[_parent.CampaignTypeNameColumn] = value; }
		}

		/// <summary>Returns true if the TypedView field CampaignTypeName is NULL, false otherwise.</summary>
		public bool IsCampaignTypeNameNull() 
		{
			return IsNull(_parent.CampaignTypeNameColumn);
		}

		/// <summary>Sets the TypedView field CampaignTypeName to NULL. Not recommended; a typed list should be used as a readonly object.</summary>
		public void SetCampaignTypeNameNull() 
		{
			this[_parent.CampaignTypeNameColumn] = System.Convert.DBNull;
		}
