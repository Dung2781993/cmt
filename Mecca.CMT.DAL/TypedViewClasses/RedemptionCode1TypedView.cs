...
namespace Mecca.CMT.DAL.TypedViewClasses
{
	...
	/// <summary>Typed datatable for the view 'RedemptionCode1'.</summary>
	[Serializable, System.ComponentModel.DesignerCategory("Code")]
	[ToolboxItem(true)]
	[DesignTimeVisible(true)]
	public partial class RedemptionCode1TypedView : TypedViewBase<RedemptionCode1Row>, ITypedView
	// __LLBLGENPRO_USER_CODE_REGION_START AdditionalInterfacesView 
	// __LLBLGENPRO_USER_CODE_REGION_END 
	{
		#region Class Member Declarations
		private DataColumn _columnRedemptionCodeId;
		private DataColumn _columnOfferCode;
	...
	// __LLBLGENPRO_USER_CODE_REGION_END 
		...
		static RedemptionCode1TypedView()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary>CTor</summary>
		public RedemptionCode1TypedView():base("RedemptionCode1")
		{
			InitClass();
		}
		...
		protected RedemptionCode1TypedView(SerializationInfo info, StreamingContext context):base(info, context)
		{
			InitMembers();
		}
	...
	// __LLBLGENPRO_USER_CODE_REGION_END 
		...
		{
			IEntityFields fieldsInResultset = EntityFieldsFactory.CreateTypedViewEntityFieldsObject(TypedViewType.RedemptionCode1TypedView);
		...
		{
			return EntityFieldsFactory.CreateTypedViewEntityFieldsObject(TypedViewType.RedemptionCode1TypedView);
		}
		...
		{
			return new RedemptionCode1Row(rowBuilder);
		}
	...
	// __LLBLGENPRO_USER_CODE_REGION_END 
		...
		private void InitMembers()
		{
			...
			_columnOfferCode = this.Columns["OfferCode"];
	...
	// __LLBLGENPRO_USER_CODE_REGION_END 
		...
		{
			RedemptionCode1TypedView cloneToReturn = ((RedemptionCode1TypedView)(base.Clone()));
		...
		{
			return new RedemptionCode1TypedView();
		}
		...
		{
			get { return RedemptionCode1TypedView.CustomProperties;}
		}
		...
		{
			get { return RedemptionCode1TypedView.FieldsCustomProperties;}
		}
		...
		/// <summary>Returns the column object belonging to the TypedView field 'OfferCode'</summary>
		internal DataColumn OfferCodeColumn 
		{
			get { return _columnOfferCode; }
		}
	...
	/// <summary>Typed datarow for the typed datatable RedemptionCode1</summary>
	public partial class RedemptionCode1Row : DataRow
	// __LLBLGENPRO_USER_CODE_REGION_START AdditionalInterfacesRow 
	// __LLBLGENPRO_USER_CODE_REGION_END 
	{
		#region Class Member Declarations
		private RedemptionCode1TypedView	_parent;
		#endregion

		/// <summary>CTor</summary>
		/// <param name="rowBuilder">Row builder object to use when building this row</param>
		protected internal RedemptionCode1Row(DataRowBuilder rowBuilder) : base(rowBuilder) 
		{
			_parent = ((RedemptionCode1TypedView)(this.Table));
		}

		#region Class Property Declarations
		/// <summary>Gets / sets the value of the TypedView field RedemptionCodeId</summary>
		/// <remarks>Mapped on view field: "redemption_codes"."redemption_code_id"<br/>
		...
		/// <summary>Gets / sets the value of the TypedView field OfferCode</summary>
		/// <remarks>Mapped on view field: "redemption_codes"."offer_code"<br/>
		/// View field characteristics (type, precision, scale, length): NVarChar, 0, 0, 20</remarks>
		public System.String OfferCode
		{
			get { return IsOfferCodeNull() ? (System.String)TypeDefaultValue.GetDefaultValue(typeof(System.String)) : (System.String)this[_parent.OfferCodeColumn]; }
			set { this[_parent.OfferCodeColumn] = value; }
		}

		/// <summary>Returns true if the TypedView field OfferCode is NULL, false otherwise.</summary>
		public bool IsOfferCodeNull() 
		{
			return IsNull(_parent.OfferCodeColumn);
		}

		/// <summary>Sets the TypedView field OfferCode to NULL. Not recommended; a typed list should be used as a readonly object.</summary>
		public void SetOfferCodeNull() 
		{
			this[_parent.OfferCodeColumn] = System.Convert.DBNull;
		}
		
		/// <summary>Gets / sets the value of the TypedView field Description</summary>
		/// <remarks>Mapped on view field: "redemption_codes"."description"<br/>
