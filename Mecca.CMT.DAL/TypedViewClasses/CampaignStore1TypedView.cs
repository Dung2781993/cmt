...
namespace Mecca.CMT.DAL.TypedViewClasses
{
	...
	/// <summary>Typed datatable for the view 'CampaignStore1'.</summary>
	[Serializable, System.ComponentModel.DesignerCategory("Code")]
	[ToolboxItem(true)]
	[DesignTimeVisible(true)]
	public partial class CampaignStore1TypedView : TypedViewBase<CampaignStore1Row>, ITypedView
	// __LLBLGENPRO_USER_CODE_REGION_START AdditionalInterfacesView 
	// __LLBLGENPRO_USER_CODE_REGION_END 
	{
		#region Class Member Declarations
		private DataColumn _columnCampaignStoreId;
	...
	// __LLBLGENPRO_USER_CODE_REGION_END 
		...
		static CampaignStore1TypedView()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary>CTor</summary>
		public CampaignStore1TypedView():base("CampaignStore1")
		{
			InitClass();
		}
		...
		protected CampaignStore1TypedView(SerializationInfo info, StreamingContext context):base(info, context)
		{
			InitMembers();
		}
	...
	// __LLBLGENPRO_USER_CODE_REGION_END 
		...
		{
			IEntityFields fieldsInResultset = EntityFieldsFactory.CreateTypedViewEntityFieldsObject(TypedViewType.CampaignStore1TypedView);
		...
		{
			return EntityFieldsFactory.CreateTypedViewEntityFieldsObject(TypedViewType.CampaignStore1TypedView);
		}
		...
		{
			return new CampaignStore1Row(rowBuilder);
		}
		...
		{
			TableName = "CampaignStore1";
			_columnCampaignStoreId = GeneralUtils.CreateTypedDataTableColumn("CampaignStoreId", @"CampaignStoreId", typeof(System.Int32), this.Columns);
	...
	// __LLBLGENPRO_USER_CODE_REGION_END 
		...
		{
			_columnCampaignStoreId = this.Columns["CampaignStoreId"];
	...
	// __LLBLGENPRO_USER_CODE_REGION_END 
		...
		{
			CampaignStore1TypedView cloneToReturn = ((CampaignStore1TypedView)(base.Clone()));
		...
		{
			return new CampaignStore1TypedView();
		}
		...
		{
			get { return CampaignStore1TypedView.CustomProperties;}
		}
		...
		{
			get { return CampaignStore1TypedView.FieldsCustomProperties;}
		}
		
		/// <summary>Returns the column object belonging to the TypedView field 'CampaignStoreId'</summary>
		internal DataColumn CampaignStoreIdColumn 
		{
			get { return _columnCampaignStoreId; }
		}
	...
	/// <summary>Typed datarow for the typed datatable CampaignStore1</summary>
	public partial class CampaignStore1Row : DataRow
	// __LLBLGENPRO_USER_CODE_REGION_START AdditionalInterfacesRow 
	// __LLBLGENPRO_USER_CODE_REGION_END 
	{
		#region Class Member Declarations
		private CampaignStore1TypedView	_parent;
		#endregion

		/// <summary>CTor</summary>
		/// <param name="rowBuilder">Row builder object to use when building this row</param>
		protected internal CampaignStore1Row(DataRowBuilder rowBuilder) : base(rowBuilder) 
		{
			_parent = ((CampaignStore1TypedView)(this.Table));
		}

		#region Class Property Declarations
		/// <summary>Gets / sets the value of the TypedView field CampaignStoreId</summary>
		/// <remarks>Mapped on view field: "campaign_stores"."campaign_store_id"<br/>
		/// View field characteristics (type, precision, scale, length): Int, 10, 0, 0</remarks>
		public System.Int32 CampaignStoreId
		{
			get { return IsCampaignStoreIdNull() ? (System.Int32)TypeDefaultValue.GetDefaultValue(typeof(System.Int32)) : (System.Int32)this[_parent.CampaignStoreIdColumn]; }
			set { this[_parent.CampaignStoreIdColumn] = value; }
		}

		/// <summary>Returns true if the TypedView field CampaignStoreId is NULL, false otherwise.</summary>
		public bool IsCampaignStoreIdNull() 
		{
			return IsNull(_parent.CampaignStoreIdColumn);
		}

		/// <summary>Sets the TypedView field CampaignStoreId to NULL. Not recommended; a typed list should be used as a readonly object.</summary>
		public void SetCampaignStoreIdNull() 
		{
			this[_parent.CampaignStoreIdColumn] = System.Convert.DBNull;
		}
		
		/// <summary>Gets / sets the value of the TypedView field CampaignId</summary>
		/// <remarks>Mapped on view field: "campaign_stores"."campaign_id"<br/>
		/// View field characteristics (type, precision, scale, length): Int, 10, 0, 0</remarks>
		...
		/// <remarks>Mapped on view field: "campaign_stores"."store_id"<br/>
		/// View field characteristics (type, precision, scale, length): Int, 10, 0, 0</remarks>
		...
		/// <remarks>Mapped on view field: "campaign_stores"."date_added"<br/>
